...
\subfigure[\label{fig:low_noise} ]{\includegraphics[width = 0.3\textwidth]{Figures/Motion11.png}} &	
\subfigure[\label{fig:low_noise2} ]{\includegraphics[width = 0.3\textwidth]{Figures/Motion22.png}} &
\subfigure[\label{fig:at_attack} ]{\includegraphics[width = 0.3\textwidth]{Figures/Motion33.png}}
\end{tabular} \\
\begin{tabular}{ccc}
\subfigure[\label{fig:after_detection} ]{\includegraphics[width = 0.3\textwidth]{Figures/Motion44.png}} &
\subfigure[\label{fig:adapt_region} ]{\includegraphics[width = 0.3\textwidth]{Figures/Motion55.png}} & 
\subfigure[\label{fig:continue_motion} ]{\includegraphics[width = 0.3\textwidth]{Figures/Motion66.png}}
...
\end{tabular} \\
\begin{tabular}{c}
\subfigure[\label{fig:total_input} ]{\includegraphics[width = 0.45\textwidth]{Figures/Total_Inputs.png}} 
%\vspace{-10pt}
\end{tabular}
%\vspace{-10pt}
...
\vspace{-5pt}
\begin{tabular}{cc}
\subfigure[\label{fig:error_comp1} ]{\includegraphics[width = 0.21\textwidth]{Figures/ErrorComparison11.png}} &	
\subfigure[\label{fig:error_comp2} ]{\includegraphics[width = 0.21\textwidth]{Figures/ErrorComparison22.png}}
\end{tabular} 
\vspace{-10pt}
