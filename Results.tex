...
\subfigure[\label{fig:low_noise} ]{\includegraphics[width = 0.23\textwidth]{Motion1.png}} &	

\subfigure[\label{fig:high_noise} ]{\includegraphics[width = 0.23\textwidth]{Motion2.png}}  &
	
\subfigure[\label{fig:near_obstacle} ]{\includegraphics[width = 0.23\textwidth]{Motion3.png}} &

\subfigure[\label{fig:far_obstacle} ]{\includegraphics[width = 0.23\textwidth]{Motion4.png}}
