...
\subfigure[\label{fig:error_comp1} ]{\includegraphics[width = 0.21\textwidth]{Figures/ErrorComparison1.png}} &	
\subfigure[\label{fig:error_comp2} ]{\includegraphics[width = 0.21\textwidth]{Figures/ErrorComparison2.png}}
\end{tabular} 

\caption{In the case of an adversary performing a stealthy attack within the noise profile, using a value of $N_p>1$ from \eqref{eq:max_error2} reduces the detection error threshold \eqref{eq:delta} for better visibility. }
