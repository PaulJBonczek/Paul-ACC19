...
\subfigure[\label{fig:low_noise} ]{\includegraphics[width = 0.3\textwidth]{Motion1.png}} &	
\subfigure[\label{fig:low_noise2} ]{\includegraphics[width = 0.3\textwidth]{Motion2.png}} &
\subfigure[\label{fig:at_attack} ]{\includegraphics[width = 0.3\textwidth]{Motion3.png}}
\end{tabular} \\
\begin{tabular}{ccc}
\subfigure[\label{fig:after_detection} ]{\includegraphics[width = 0.3\textwidth]{Motion4.png}} &
\subfigure[\label{fig:adapt_region} ]{\includegraphics[width = 0.3\textwidth]{Motion5.png}} & 
\subfigure[\label{fig:continue_motion} ]{\includegraphics[width = 0.3\textwidth]{Motion6.png}}
