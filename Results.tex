...
In Figure \ref{fig:low_noise}, the vehicle is moving along the trajectory with no compromised sensors and far from obstacles. The confidence region is, small in this case because all sensors are available and fused together. %Velocity is unaltered due to the obstacles being well outside the uncertainty boundaries.
