...
% esen icra paper, acc paper, cps 2014 look how the intro is written, try to put down itno and problem formulation

% PRESENT TENSE!!
% Dont give a solution, just say what the problem is that you're trying to solve
% Find the policy to detect the compromised 
% differentiate system will have dynamical change, differentiate between cyber attack and dynamical change
% detect cyber attack, adaptive systems to work in a compromised environment
% describe how system is nonlinear system  but at the point in time its "linear"
