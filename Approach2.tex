...
\begin{proof}
The proof is intuitive and follow a similar argument as presented in \NB{add citation here}. Under the assumptions (A1-A4) and the convergence property from \eqref{eq:Modified_Proj_Algorithm},
    \begin{equation}
    \label{lemma_1_eq1}
