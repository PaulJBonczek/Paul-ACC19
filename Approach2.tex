...
\subfigure[\label{fig:1sample} ]{\includegraphics[width = 0.22\textwidth]{sample_1.png}} &	

\subfigure[\label{fig:5samples} ]{\includegraphics[width = 0.22\textwidth]{sample_5.png}}
...
\subfigure[\label{fig:step_one} ]{\includegraphics[width = 0.18\textwidth]{pseudo_static_left.png}} &	

\subfigure[\label{fig:step_two} ]{\includegraphics[width = 0.18\textwidth]{pseudo_static_right.png}}
