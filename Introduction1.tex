...
TALK TO NICOLA ON HOW TO STRUCTURE THE RELATED WORK. WE HAVE TWO SEPARATE PROBLEMS AT HAND. (DISCUSS THE PROBLEMS IN SERIES OR PARALLEL). \NB{first literature on cyber-security of CPS under sensor attacks, then mention that we are using AC and list relevant literature on AC here. Finally mention that we are proposing a replanning approach and list some previous work on this topic}
